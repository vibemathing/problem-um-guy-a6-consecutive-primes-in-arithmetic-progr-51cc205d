...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GUY-A6"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-v1",
      "problem_contract_sha256": "27b9f0d76a8c3ea642195a9c60ecab2f2a975afea568221d59e11b2735671d12",
      "problem_id": "problem:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d",
      "route_id": "route:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-source-fidelity-01",
      "graph_id": "graph:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are there arbitrarily long arithmetic progressions of consecutive primes? That is, for any positive integer $k$, do there exist $k$ consecutive primes $p_n, p_{n+1}, \\ldots, p_{n+k-1}$ in arithmetic progression?"
          },
          "statement_sha256": "b3e66c631f318e72ddb2ce3a3e0221fc2238c0ced8344b1547660f4df60b431b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-root",
      "route_id": "route:um-guy-a6-consecutive-primes-in-arithmetic-progr-51cc205d-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-guy-a6-9b3c9c4d2e2d",
        "url": "https://www.unsolvedmath.com/problems/GUY-A6"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
